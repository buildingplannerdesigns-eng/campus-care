export const drCammieCopy = {
  ...
  intro: {
    ...
    cta: "Learn How I Did It",
  },
  overwhelm: {
    heading: "Healing from intergenerational trauma might seem overwhelming",
    body: [
      "but it doesn't have to be.",
      "Follow my system and create a culturally grounded path where you get to heal, strengthen relationships, make an impact, and build lasting wellness...",
      "in less time.",
    ],
  },
  steps: [
    {
      number: "01",
      title: "Join a Workshop or Training",
      description:
  ...
  faith: {
    ...
    reference: "Inspire Hope, Purpose and Collective Action",
    scripture: "Joshua 1:9",
    quote: "Be strong and courageous.",
  },
  feature: {
    badge: "Speaker · Workshops · Coaching",
    badgeSub: "Expert-Led",
    heading:
  ...
  story: {
    paragraphs: [
      "For many years, breaking free from intergenerational trauma patterns felt impossible. I wanted to help others heal, but the path wasn't always clear. I wanted to build a practice with compassion and cultural understanding at the center, but I didn't know how.",
      "After years of clinical work and community impact, I finally found the system.",
      "God showed me how to help people heal in less time using culturally grounded, evidence-based practices. An approach that honors lived experience. A practice that doesn't depend on one-size-fits-all solutions.",
      "The work I've built allows me to meet people where they are, strengthen relationships, make a significant impact, and create lasting transformation.",
    ],
    calloutQuote:
